...
public class DemoPersonas {
    public static LinkedList<Persona> getPersonas(String archivosDePersonas) {
        File f = null;
        FileReader fr = null;
    ...
    public static LinkedList<Persona> getPersonasMayoresDeEdad(LinkedList<Persona> lp, int edad) {
    ...
    public static void generararchivoDePersonasMayores(LinkedList<Persona> l, int edad) throws IOException {
        ...
        LinkedList<Persona> mayores = getPersonasMayoresDeEdad(l, edad);
    ...
    public static TreeMap<Integer, LinkedList<Persona>> agruparPorEdad(LinkedList<Persona> lp) {
        ...
        for (Persona persona : lp) {
            ...
            if (personasPorEdad.containsKey(key)) {
                ...
                value.add(persona);
            } else { // se crea la lista si no la tiene
    ...
    public static void main(String[] args) throws IOException {
        ...
        // }
        // System.out.println("Total de personas: " + lp.size());

        //Genera un archivo sólo con personas mayores de 30
        generararchivoDePersonasMayores(lp, 30);

        //Genera un archivo agrupando personas por edad
