...
public class EmpleadosTest {
	...
	public void creoUnGerenteParametrizadoTest() {
		...
		Gerente raul = new Gerente("Raul", 250000, "Informática");
		assertEquals(250000*1.2, raul.getSalario(), 0.001);
	}
}
